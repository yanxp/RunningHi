...
public class DataActivityFragment  extends Fragment {
private  ImageButton mback,mstop,mnext,mover;
    ...
    View v = inflater.inflate(R.layout.data_activity, parent, false);
		...
		mover= (ImageButton) v.findViewById(R.id.over);
